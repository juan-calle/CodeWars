...
// Trolls: 5
// Wizards: 10
// Although weather, location, supplies and valor play a part in any battle, if you
//  add up the worth of the side of good and compare it with the worth of the side
...
function goodVsEvil(good, evil) {
  ...
  let powerGood = goodArmy[0] * 1 + goodArmy[1] * 2 + goodArmy[2] * 3 +
      goodArmy[3] * 3 + goodArmy[4] * 4 + goodArmy[5] * 10;
  let powerEvil = evilArmy[0] * 1 + evilArmy[1] * 2 + evilArmy[2] * 2 +
      evilArmy[3] * 2 + evilArmy[4] * 3 + evilArmy[5] * 5 + evilArmy[6] * 10;
